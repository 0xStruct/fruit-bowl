          ...
          <div>
            ...
            <div className="mt-1">
              <textarea
                ...
                name="invalid"
                id="invalid"
                className="focus:ring-rose-700 focus:border-rose-700 bg-rose-300/10 resize-none block w-full border-rose-700 font-flow text-lg placeholder:text-gray-400"
                disabled={true}
