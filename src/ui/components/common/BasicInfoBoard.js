          ...
          <div className="mt-1">
            <input
              ...
              className="bg-drizzle-green-ultralight block w-full border-drizzle-green font-flow text-lg rounded-2xl
                focus:ring-drizzle-green-dark focus:border-drizzle-green-dark  placeholder:text-gray-400"
        ...
        <div className="flex flex-col gap-y-2">
          ...
          <div className="mt-1">
            <input
              ...
              className="focus:ring-drizzle-green-dark focus:border-drizzle-green-dark rounded-2xl
              bg-drizzle-green-ultralight block w-full border-drizzle-green font-flow text-lg placeholder:text-gray-400"
