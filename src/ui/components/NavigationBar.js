      ...
      <div className="flex items-center gap-x-2">
        <Link href="/">
          <div className="min-w-[40px]">
            <Image src="/peachy-pink.png" alt="" width={50} height={50} priority={true} />
          </div>
        </Link>
        ...
        <label className="hidden sm:block px-1 text-center font-flow text-drizzle-green font-light text-xs border border-1 border-drizzle-green">
          {`${publicConfig.chainEnv == "mainnet" ? "BETA" : "TESTNET"}`}
        </label>
        <label className="block sm:hidden px-1 text-center font-flow text-drizzle-green font-light text-xs border border-1 border-drizzle-green">
