...
const fruitAddress = process.env.NEXT_PUBLIC_FRUIT_ADDRESS
if (!fruitAddress) throw "Missing NEXT_PUBLIC_FRUIT_ADDRESS"

const fruitRecorderAddress = process.env.NEXT_PUBLIC_FRUIT_RECORDER_ADDRESS
if (!fruitRecorderAddress) throw "Missing NEXT_PUBLIC_FRUIT_RECORDER_ADDRESS"
