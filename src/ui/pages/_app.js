  ...
  return (
    <>
      <div className="bg-white text-black bg-[url('/bg.png')] bg-cover bg-center min-h-screen">
        <RecoilRoot>
          <Head>
            <title>Fruit Bowl | fun social defi dapp for friendly wagers</title>
            <meta property="og:title" content="Fruit Bowl | fun social defi dapp for friendly wagers" key="title" />
          </Head>
